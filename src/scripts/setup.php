...
if (!$stopSetup) {
    ...
    $dbConnectSrc = $versionDir . 'db/db_connect.dist.php';
    ...
    $hroseIniSrc = $versionDir . 'inc/hrose_ini.dist.php';
    ...
    $configIncSrc = $versionDir . 'inc/config.inc.dist.php';
